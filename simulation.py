...
plt.savefig(f'figs/dt{dt}-alt-time.jpg')
plt.close()
...
plt.savefig(f'figs/dt{dt}-vz-time.jpg')
plt.close()
...
plt.savefig(f'figs/dt{dt}-vx-time.jpg')
plt.close()
...
plt.savefig(f'figs/dt{dt}-fd-time.jpg')
plt.close()
...
plt.savefig(f'figs/dt{dt}-az-time.jpg')
plt.close()
...
plt.title("X vs Z")
plt.legend()
plt.savefig(f'figs/dt{dt}-x-z.jpg')
plt.close()
...
plt.legend()
plt.savefig(f'figs/dt{dt}-speed-time.jpg')
plt.close()
...
plt.ylabel("Best burn altitude (m)")
plt.title("Launch Ratio vs Landing Burn Altitude")
plt.savefig(f'figs/dt{dt}-lr-altitude.jpg')
plt.close()
